...
Podcasts suit the commute and the gym, and the ones listed here cover AI developments at a pace that written sources rarely match. Each entry names the host, states what the show covers, and records the date on which we last confirmed that the show was still publishing. A podcast that has gone quiet for more than three months is retired from this list at the next refresh.
...
**Podcast**, Nathaniel Whittemore. A podcast publishing AI news and analysis every day, giving students a regular briefing on how the field is moving without a large time commitment. Featured in [Module 1](../path/module-01.md). *Last verified 2026-09-07.*

### [The Cognitive Revolution](https://www.cognitiverevolution.ai/)

**Podcast**, Nathan Labenz. A weekly podcast of interviews with AI innovators about the transformative near-term impact of AI, with in-depth expert conversations and AI Scouting Reports on critical topics for students tracking where the technology is heading. *Last verified 2026-09-07.*
