# Tools with Student Offers

Several vendors offer students free or discounted access to paid AI tools, and the entries below record the terms as stated on the vendor's own page on the date shown. Offer terms change by semester, and eligibility often depends on a verified academic email address or a specific country. Thus, we recommend confirming the current terms on the linked page before enrolling, and we retire an entry as soon as a refresh finds that the offer has ended.
...
**Tool**, Google. U.S. college students aged 18 and older get one year of free access, with eligibility verified yearly, a valid form of payment required at sign-up, automatic renewal at $19.99 per month unless cancelled, and redemption required by December 31, 2026. Featured in [Module 1](../path/module-01.md). *Last verified 2026-09-07.*
